...
const Home = () => {
  ...
  const handleEnterWindow = (e, path, index) => {
    ...
    setTimeout(() => {
      navigate(path);
      window.scrollTo(0, 0);
    }, 1000); // Wait for the 1000ms hyper-smooth zoom animation before actually routing
  };
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans bg-brand-bg relative overflow-x-clip">
      ...
      {/* --- PALACE GATEWAYS (ARCH NAVIGATION) --- */}
      <section className="py-24 bg-[url('https://www.transparenttextures.com/patterns/arabesque.png')] bg-brand-bg relative mix-blend-color-dodge">
